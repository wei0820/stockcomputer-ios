//
//  ForeignInvestmentViewController.swift
//  stockcomputer
//
...
class ForeignInvestmentViewController: MGoogleADViewController , UITableViewDataSource
, UITableViewDelegate ,UITabBarDelegate{
    ...
    func getData(){
        ...
        itemName =  GetStockPriceManager.getForeigninvestment()
    ...
    func getData_2(){
        itemName.removeAll()
         ...
         hud?.textLabel.text = "Loading"
         hud?.show(in: self.view)
         itemName =  GetStockPriceManager.getForeigninvestment_2()
         hud?.dismiss(afterDelay: 3.0)
        tableview.reloadData()
